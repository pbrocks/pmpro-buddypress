...
class Help_Welcome_Menus {
	...
	public function pmpbro_admin_help_tab() {
		$pmpbro_help_page = add_dashboard_page( __( 'PMPBro Help Tab Page', 'pmpbro' ), __( 'PMPBro Help Tab Page', 'pmpbro' ), min_caps, 'pmpbro.php', array( $this, 'pmpbro_help_admin_page' ) );
