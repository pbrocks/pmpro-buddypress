...
?>
selected="selected"<?php } ?>><?php _e( 'Yes - Give members access to all of BuddyPress', 'pmpro' ); ?></option>
						<option value="2" 
						<?php
						if ( $pmpro_bp_restrictions == 2 ) {
?>
selected="selected"<?php } ?>><?php _e( 'Yes - Give members access to specific features', 'pmpro' ); ?></option>
				</select><br />
				</td>
			</tr>
			</tbody>
